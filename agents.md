...
- **Rules**: Use DotRush / Roslyn context to avoid compilation errors. Never regenerate full files when a minor patch works. Never perform any Git commit or Git push operations without asking for explicit user confirmation first.
